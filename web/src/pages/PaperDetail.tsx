        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <Star className={`h-5 w-5 ${paper.is_favorite ? 'fill-yellow-400 text-yellow-400' : ''}`} />
              </Button>
              <Button
                variant="destructive"
                size="icon"
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              <Badge variant={paper.priority === 'High' ? 'destructive' : paper.priority === 'Medium' ? 'default' : 'outline'}>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Annotations feature coming soon. You'll be able to add highlights and notes to your papers.
                  </p>
                </CardContent>
              </Card>
            </TabsContent>
