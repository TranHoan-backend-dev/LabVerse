                ...
                <div key={idx}>
                  ...
                  <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    {section.papers.map((paper, paperIdx) => (
                      <Card key={paperIdx} className="shadow-custom-sm hover:shadow-custom-md transition-shadow">
                        <CardHeader>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Our AI analyzes your library and reading patterns to suggest relevant papers. 
