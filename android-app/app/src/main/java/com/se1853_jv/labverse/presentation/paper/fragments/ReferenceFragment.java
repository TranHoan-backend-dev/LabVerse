...
public class ReferenceFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.layout_paperdetails_tab_reference, container, false);
    }
            ...
            public void onSuccess(List<Citation> data) {
                ...
                requireActivity().runOnUiThread(() -> {
                    if (!data.isEmpty()) {
                        ...
                        Log.d("ReferenceFragment", "Size of container: " + container.getChildCount());
                    }
                });
            }
    ...
    @RequiresApi(api = Build.VERSION_CODES.UPSIDE_DOWN_CAKE)
    private void handleCopyReference(@NonNull View parent) {
