...
import com.se1853_jv.labverse.data.service.paper.ApiPaperService;
...
public class PaperApi {
    ...
    private final ApiPaperService apiService;
    ...
    public PaperApi() {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        apiService = retrofit.create(ApiPaperService.class);
    }
