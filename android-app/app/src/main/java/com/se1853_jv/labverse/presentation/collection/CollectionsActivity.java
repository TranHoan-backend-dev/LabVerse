...
import com.se1853_jv.labverse.presentation.collection.adapter.CollectionsAdapter;
...
public class CollectionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_common_home_with_no_search);
    ...
    private void setupViewPager() {
        ...
        var adapter = new CollectionsAdapter(this);
    ...
    public void showEditCollectionDialog(CollectionResponse collection) {
        ...
        View dialogView = getLayoutInflater().inflate(R.layout.layout_dialog_create_collection, null);
